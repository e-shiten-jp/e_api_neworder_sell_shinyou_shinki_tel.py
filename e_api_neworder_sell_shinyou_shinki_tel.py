...
# 引数6: 株数
# 引数7: 口座属性クラス
def func_neworder_sell_sinyou_open(int_p_no,
                                  str_sIssueCode,
                                  str_sSizyouC,
                                  str_sCondition,
                                  str_sOrderPrice,
...
if __name__ == "__main__":
    ...
    if my_login_property.sSinyouKouzaKubun == '1' :
        # 信用 新規 売り注文    引数：p_no、銘柄コード、市場（現在、東証'00'のみ）、執行条件、価格、株数、口座属性クラス
        dic_return = func_neworder_sell_sinyou_open(my_login_property.p_no,
                                                   my_sIssueCode,
                                                   my_sSizyouC,
                                                   my_sCondition,
                                                   my_sOrderPrice,
